import core.Game;
import players.*;
import players.assign.MCTSParamsNew;
import players.assign.MCTSPlayerNew;
            ...
            for(int i = 4; i <= 7; ++i) {
                ...
                switch(agentType) {
                    ...
                    case 5:
                        ...
                        break;
                    case 6:
                        MCTSParamsNew mctsParamsn = new MCTSParamsNew();
                        mctsParamsn.stop_type = mctsParamsn.STOP_ITERATIONS;
                        mctsParamsn.num_iterations = 200;
                        mctsParamsn.rollout_depth = 12;

                        mctsParamsn.heuristic_method = mctsParamsn.CUSTOM_HEURISTIC;
                        p = new MCTSPlayerNew(seed, playerID++, mctsParamsn);
